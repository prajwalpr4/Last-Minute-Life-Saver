      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed inset-4 sm:inset-auto sm:top-1/2 sm:left-1/2 sm:-translate-x-1/2 sm:-translate-y-1/2 sm:w-full sm:max-w-lg sm:max-h-[85vh] bg-background border-2 border-red-500 rounded-2xl shadow-[0_0_80px_-12px_rgba(220,38,38,0.7)] z-50 overflow-hidden flex flex-col"
          >
